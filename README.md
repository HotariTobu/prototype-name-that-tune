...
5. Each round:
   ...
   - **Wrong answer penalty (お手つき)**: if a player submits an incorrect answer, they are locked out from answering for a configurable duration (default: 5 seconds). The host can adjust or disable this penalty at room creation
